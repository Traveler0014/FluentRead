 ...
 * 主要内容：导出 createTranslationCore、TranslationCandidateCore、站点 registry、语言解析、译文字体族解析、文本槽序列化及声明式适配器，隐藏 internal.ts 等实现细节。 可核对的公开符号包括 createTranslationCore、聚合导出。
...
export type {TranslationScript} from './font';
export {
